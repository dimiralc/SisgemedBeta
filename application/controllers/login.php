...
class Login extends CI_Controller {
	...
	public function index(){    
        ...
        switch ($idperfil){
            ...
            case '': $this->_cargarPaginaLogin(); break;
		    
		    //perfil administrador
            case 1: redirect(base_url().'administrador'); break;

            //perfil paciente
            case 3: redirect(base_url().'paciente'); break;
					
            //perfil profesional
            case 2: redirect(base_url().'profesional'); break;
