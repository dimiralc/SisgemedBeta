...
<br>
    ...
    <br><br>
    <i>
        <b><u>Reporte</u>: &laquo; Antecedentes Alergias &raquo;</b><br>
    </i>
    ...
    <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;">
        <tr>
            <th style="width: 15%; text-align:left">Tipo</th>
            <th style="width: 15%; text-align:left">Alergia</th>
        ...
        if($ant_alergias!="0"){
            ...
            foreach ($ant_alergias->result() as $alergia){
            ?>
            <tr>
            <td style="width: 15%;background: #FFFFFF; text-align: left; font-size: 10pt"><?=ucwords($alergia->nombre_alergia);?></td>
            <td style="width: 15%;background: #FFFFFF; text-align: left; font-size: 10pt"><?=ucwords($alergia->alergia);?></td>
            <td style="width: 15%;background: #FFFFFF; text-align: left; font-size: 10pt"><?=$alergia->fecha_ingreso;?></td>
            <td style="width: 55%;background: #FFFFFF; text-align: left; font-size: 10pt"><?=$alergia->descripcion;?></td>
            </tr>
            <?php
            }
