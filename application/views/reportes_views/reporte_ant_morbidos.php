...
<br>
    ...
    <br><br>
    <i>
        <b><u>Reporte</u>: &laquo; Antecedentes M&oacute;rbidos &raquo;</b><br>
    </i>
    ...
    <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;">
        <tr>
            ...
            <th style="width: 55%; text-align:left">Diagn&oacute;stico</th>
        </tr>
        <?php 
        if($ant_morbidos!="0"){
            
            foreach ($ant_morbidos->result() as $ant_morbido){
                
                //setear tipo antecedente morbido
                switch ($ant_morbido->tipo) {
                    case "E":
                        $tipo_ant_morbido="Enfermedad";
                        break;
                    case "O":
                        $tipo_ant_morbido="Operaci&oacute;n";
                        break;
                    case "T":
            ...
            <tr>
                ...
                <td style="width: 55%;background: #FFFFFF; text-align: left; font-size: 10pt">
                   <?=$ant_morbido->diagnostico;?>
                </td>
            </tr>
            <?php
            }
            ...
            ?>
            <tr>
                <td colspan="4" style="width:100%;background: #FFFFFF; text-align: left; font-size: 10pt">Sin Información</td>
            </tr>
            <?php
        }
        ?>  
