...
<br>
    ...
    <br><br>
    <i>
        <b><u>Reporte</u>: &laquo; Antecedentes Medicamentos &raquo;</b><br>
    </i>
    ...
    <table cellspacing="0" style="width: 100%; border: solid 1px black; background: #E7E7E7; text-align: center; font-size: 10pt;">
        <tr>
            <th style="width: 5%; text-align:left">Cod.</th>
            <th style="width: 30%; text-align:left">Medicamento</th>
            <th style="width: 15%; text-align:left">Inicio</th>
            <th style="width: 15%; text-align:left">Fin</th>
            <th style="width: 10%; text-align:left">Duraci&oacute;n</th>
            <th style="width: 25%; text-align:left">Indicaci&oacute;n</th>
        </tr>
        <?php 
        
        if($ant_medicamentos!="0"){
            
            foreach ($ant_medicamentos->result() as $med){
            ?>
            <tr>
            <td style="width: 5%;background: #FFFFFF; text-align: left; font-size: 10pt"><?=$med->id_med;?></td>
            <td style="width: 30%;background: #FFFFFF; text-align: left; font-size: 10pt"><?=$med->nombre_medicamento;?></td>
            <td style="width: 15%;background: #FFFFFF; text-align: left; font-size: 10pt"><?=$med->fecha_inicio;?></td>
            <td style="width: 15%;background: #FFFFFF; text-align: left; font-size: 10pt"><?=$med->fecha_fin;?></td>
            <td style="width: 10%;background: #FFFFFF; text-align: left; font-size: 10pt"><?=$med->duracion." D&iacute;as";?></td>
            <td style="width: 25%;background: #FFFFFF; text-align: left; font-size: 10pt"><?=$med->indicaciones;?></td>
            </tr>
            <?php
            }
