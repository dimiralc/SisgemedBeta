			...
			<div class="box-content">
				...
				<form class="form-horizontal" role="form">
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="Nombre Vacuna" data-toggle="tooltip" data-placement="bottom" title="Tooltip for last name">
						</div>
					</div>
					<div class="form-group has-success">
						<label class="col-sm-2 control-label">Virus Tratado</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="Sistema Tratado">
						</div>	
                                                <label class="col-sm-2 control-label">Zona de Aplicación</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="Zona de Aplicación">
						</div>
					</div>
					<div class="form-group">
