	...
	<div id="breadcrumb" class="col-md-12">
		...
		<div class="box">
			<div class="box-header">
					...
					<span>Administrar Consultas Médicas</span>
				</div>
				<div class="box-icons">
                    ...
                    <div class="box-content">
                        ...
                        <?= form_open('administrarCME/buscarCME') ?>
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Búsqueda por Id del Documento </label>
                                <div class="col-sm-4">
                                        <input type="text" 
                                               class="form-control" placeholder="ID del documento" 
                                               data-toggle="tooltip" data-placement="bottom" 
                                               title="Ingrese el ID del Documento" 
                                               name="ID">
                                </div>                                        
                                <div class="col-sm-4">
