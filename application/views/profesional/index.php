    ...
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-content no-padding">
                <div id="genero" style="width:65%; height:290px; float: left;"></div>
                <div id="pacientes" style="width:35%; height:290px; float: right;"></div>
                             
            </div>  
            <div class="box-content no-padding">
                <div id="enfermedades" style="width:65%; height:290px; float: left;"></div>
                <div id="patologias" style="width:35%; height:290px; float: right;" ></div>
            </div>    
        </div>
    </div>
</div>
