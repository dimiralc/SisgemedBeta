...
<html lang="en">
  <head>
    ...
    <meta name="msapplication-TileImage" content="<?=base_url();?>/img/inicio_sesion/logotipo.png" />

    <!-- Bootstrap -->
    <link rel="stylesheet" href="<?=base_url();?>css/validar/bootstrap.css"/>
    <link rel="stylesheet" href="<?=base_url();?>css/validar/bootstrapValidator.css"/>
    <!-- Metis core stylesheet -->
    <link rel="stylesheet" href="<?=base_url();?>css/inicio_sesion/main.css">
    <link rel="stylesheet" href="<?=base_url();?>css/inicio_sesion/animate.min.css">
...
//creamos opciones del select de instituciones
$instituciones = $instituciones;

// clase del select de instituciones
$datosInstitucion = 'class="form-control"'; 
...
?>
    <div class="form-signin">
      <div class="text-center">
        <img src="<?=base_url();?>/img/inicio_sesion/logotipo.png" width="121px;"   alt="SISGEMED">
      </div>
      <hr>
...
<?php } ?>
                ...
                <div class="form-group">
                <!-- creamos el select institucion -->
                <?=form_dropdown('institucion',$instituciones,'',$datosInstitucion);?>
                    <!--  mensaje de error , validacion del campo-->
...
<?php } ?>
    ...
    <script type="text/javascript" src="<?=base_url();?>js/validar/jquery-1.10.2.min.js"></script>
    <script type="text/javascript" src="<?=base_url();?>js/validar/bootstrap.min.js"></script>
                            ...
                            username: {
                                ...
                                validators: {
                                    ...
                                    stringLength: {
                                        min: 1,
                                        max: 30,
                                        message: 'El nombre de usuario debe ser mayor de 1 y menos de 30 caracteres de longitud.'
                                    },
                                    /*remote: {
                                        url: 'remote.php',
