...
class AdministrarCME extends CI_Controller {
    ...
    function agregarCME() {
        ...
        $data['arrSintomasGinecoobstetricos'] = $this->administrarcme_model->getSintomasGinecoobstetricos();
        ...
        $data['arrSintomasGenerales'] = $this->administrarcme_model->getSintomasGenerales();
        $data['arrSintomasRespiratorio'] = $this->administrarcme_model->getSintomasRespiratorio();
        $data['arrSintomasCardiovascular'] = $this->administrarcme_model->getSintomasCardiovascular();
        $data['arrSintomasGastrointestinal'] = $this->administrarcme_model->getSintomasGastrointestinal();
        $data['arrSintomasGenitourinarios'] = $this->administrarcme_model->getSintomasGenitourinarios();
        $data['arrSintomasNeurologicos'] = $this->administrarcme_model->getSintomasNeurologicos();
        $data['arrSintomasEndocrinos'] = $this->administrarcme_model->getSintomasEndocrinos();
        $data['arrSintomasDeambulacion'] = $this->administrarcme_model->getSintomasDeambulacion();
        $data['arrSintomasFacie'] = $this->administrarcme_model->getSintomasFacie();
        $data['arrSintomasPiel'] = $this->administrarcme_model->getSintomasPiel();
